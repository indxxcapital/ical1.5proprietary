...
foreach($request_array as $id=>$indxx_array)			
{
	...
	$insertweights='Insert into tbl_weights set date="'.$indxx_array['index_value']['date'].'", isin="'.$newsecurity['isin'].'", share="'.$share.'",code="'.$indxx_array['index_value']['code'].'",price="'.$newsecurity['calcprice'].'",weight="'.$TempWeight.'",indxx_id="'.$id.'"'; 
	
		$this->db->query($insertweights);
		
		$insertweightsopen='Insert into tbl_weights_open set date="'.$indxx_array['index_value']['date'].'", isin="'.$newsecurity['isin'].'", share="'.$share.'",code="'.$indxx_array['index_value']['code'].'",price="'.$newsecurity['calcprice'].'",weight="'.$TempWeight.'",indxx_id="'.$id.'"'; 
...
$this->Redirect("index.php?module=calcstockaddtemp&log_file=".basename(log_file)."&date=".date,"","");	
