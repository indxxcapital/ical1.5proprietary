...
function addstock(){
	...
	{
	//$this->pr($_POST,true);
	if(!empty($_POST['indxx_id']))
	{
	foreach($_POST['indxx_id'] as $indxx_id)
	{
	if($_POST['weight_'.$indxx_id])
	{
    $req_id=0;	
...
$this->db->query("insert into ` tbl_replace_runnsecurity`  (status,indxx_id ,security_id,req_id) values ('1','".$indxx_id."','".$_SESSION['delistsecurity']."','".$req_id."');"); 
	...
	if($req_id)
	{
		...
		$this->db->query("insert into tbl_runnsecurities_replaced  (name,isin,ticker,curr,divcurr,cusip,sedol,countryname,indxx_id ,status,req_id,value) values ('".$_POST['name']."','".$_POST['isin']."','".$_POST['ticker']."','".$_POST['curr']."','".$_POST['divcurr']."','".$_POST['cusip']."','".$_POST['sedol']."','".$_POST['countryname']."','".$indxx_id."','1','".$req_id."','".$_POST['weight_'.$indxx_id]."')");
		}else{
		//update Query///tbl_runnsecurities_replaced
		$query=$this->db->getResult("update  tbl_runnsecurities_replaced set name='".$_POST['name']."',ticker='".$_POST['ticker']."',curr='".$_POST['curr']."',divcurr='".$_POST['divcurr']."',cusip='".$_POST['cusip']."',sedol='".$_POST['sedol']."',countryname='".$_POST['countryname']."',value='".$_POST['weight_'.$indxx_id]."' where indxx_id='".$indxx_id."' and req_id='".$req_id."' and isin='".$_POST['isin']."'",false);
