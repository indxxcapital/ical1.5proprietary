<?php /* Smarty version 2.6.14, created on 2015-12-09 00:14:41
         compiled from casecurities/download.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'casecurities/download.tpl', 7, false),)), $this); ?>
<!-- BEGIN Main Content -->
 <?php echo '
 <script>
...
<div class="row-fluid">
      ...
      <input type="hidden" name="module" value="casecurities" />
      <input type="hidden" name="event" value="download1" />
